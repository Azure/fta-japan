...
- [2. Azure における監視の全体像と機能概要](#2-azure-における監視の全体像と機能概要)
  ...
  - [2.3 そのほかの技術的なトピック](#23-そのほかの技術的なトピック)
    ...
    - [Log Analytics ワークスペースの利用状況の分析](#log-analytics-ワークスペースの利用状況の分析)
  - [2.4 まとめ](#24-まとめ)
...
プラットフォームのログとしてはほかに、リソースの作成や削除、アラートを記録している `アクティビティ ログ`、 ユーザーのサインインや監査ログを記録している `Azure Active Directory ログ` があります。これらのログも、診断設定から出力先を設定できます。
...
Log Analytics ワークスペースに作成されたテーブルは、[テーブル]メニューから確認できます。
