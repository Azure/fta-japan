...
[アプリケーションに適した Azure コンピューティング サービスを選択する](https://docs.microsoft.com/ja-jp/azure/architecture/guide/technology-choices/compute-decision-tree#choose-a-candidate-service)
...
| 利点 | 制限 |
| -------- | ----------- |
| Azure に数秒でデプロイ<br>コードまたはコンテナをデプロイ<br>必要に応じて簡単にスケール<br>Web アプリケーションに適しています<br>デプロイメント スロットを使用して、ダウンタイムを最小限に抑える|複数のコンテナのデプロイ<br>DAPR (Distributed Application Runtime)<br>KEDA (Kubernetes Event-driven Autoscaler) を使用したイベント駆動プロセッシングの処理<br>|
